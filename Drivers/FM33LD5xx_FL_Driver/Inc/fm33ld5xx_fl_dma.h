...
#ifndef __FM33FG5XX_FL_DMA_H
#define __FM33FG5XX_FL_DMA_H
...
#define    DMA_DMA_CH7CR_PRI_Pos                                  (12U)
#define    DMA_DMA_CH7CR_PRI_Msk                                  (0x3U << DMA_DMA_CH7CR_PRI_Pos)
#define    DMA_DMA_CH7CR_PRI                                      DMA_DMA_CH7CR_PRI_Msk

#define    DMA_CH7CR_DIR_Pos                                      (10U)
#define    DMA_DMA_CH7CR_DIR_Msk                                  (0x1UL << DMA_CH7CR_DIR_Pos)
#define    DMA_DMA_CH7CR_DIR                                      DMA_DMA_CH7CR_DIR_Msk

#define    DMA_CH7CR_RINC_Pos                                     (9U)
#define    DMA_DMA_CH7CR_RINC_Msk                                 (0x1U << DMA_CH7CR_RINC_Pos)
#define    DMA_DMA_CH7CR_RINC                                     DMA_DMA_CH7CR_RINC_Msk

#define    DMA_CH7CR_FINC_Pos                                     (8U)
#define    DMA_DMA_CH7CR_FINC_Msk                                 (0x1U << DMA_CH7CR_FINC_Pos)
#define    DMA_DMA_CH7CR_FINC                                     DMA_DMA_CH7CR_FINC_Msk
...
#define    FL_DMA_CHANNEL_QSPI                                    (0x34U)
...
#define    FL_DMA_CHANNEL_ATIM2_CH1                               (0x43U)
#define    FL_DMA_CHANNEL_ATIM2_CH2                               (0x44U)
#define    FL_DMA_CHANNEL_ATIM2_CH3                               (0x45U)
#define    FL_DMA_CHANNEL_ATIM2_CH4                               (0x46U)
#define    FL_DMA_CHANNEL_ATIM2_TRIG                              (0x47U)
#define    FL_DMA_CHANNEL_ATIM2_COM                               (0x48U)
#define    FL_DMA_CHANNEL_ATIM2_UEV                               (0x49U)
...
#define    FL_DMA_CHANNEL_GPTIM5_CH1                              (0x56U)
#define    FL_DMA_CHANNEL_GPTIM5_CH2                              (0x57U)
#define    FL_DMA_CHANNEL_GPTIM5_CH3                              (0x58U)
#define    FL_DMA_CHANNEL_GPTIM5_CH4                              (0x59U)
#define    FL_DMA_CHANNEL_GPTIM5_TRIG                             (0x5aU)
#define    FL_DMA_CHANNEL_GPTIM5_UEV                              (0x5bU)
#define    FL_DMA_CHANNEL_TAU0_0                                  (0x5cU)
#define    FL_DMA_CHANNEL_TAU0_1                                  (0x5dU)
#define    FL_DMA_CHANNEL_TAU0_2                                  (0x5eU)
#define    FL_DMA_CHANNEL_TAU0_3                                  (0x5fU)
#define    FL_DMA_CHANNEL_BSTIM0_TRIG                             (0x62U)
#define    FL_DMA_CHANNEL_LPTIM0_TRIG                             (0x63U)
#define    FL_DMA_CHANNEL_ADC0_COMB                               (0x6fU)
#define    FL_DMA_CHANNEL_ADC0_SACQ                               (0x70U)
#define    FL_DMA_CHANNEL_ADC1_COMB                               (0x71U)
#define    FL_DMA_CHANNEL_ADC1_SACQ                               (0x72U)
#define    FL_DMA_CHANNEL_ADC2_COMB                               (0x73U)
#define    FL_DMA_CHANNEL_ADC2_SACQ                               (0x74U)
#define    FL_DMA_CHANNEL_ADC3_COMB                               (0x75U)
#define    FL_DMA_CHANNEL_ADC3_SACQ                               (0x76U)
#define    FL_DMA_CHANNEL_DAC0                                    (0x77U)
#define    FL_DMA_CHANNEL_DAC1                                    (0x78U)
#define    FL_DMA_CHANNEL_CORDIC_INA                              (0x79U)
#define    FL_DMA_CHANNEL_CORDIC_INB                              (0x7aU)
#define    FL_DMA_CHANNEL_CORDIC_OUT                              (0x7bU)
...
__STATIC_INLINE void FL_DMA_EnableChannel(DMA_Type *DMAx, uint32_t channel)
{
    ...
    {
        SET_BIT(Temp->DMA_CH7CR, DMA_CHCR_EN_Msk);
    }
}
...
__STATIC_INLINE uint32_t FL_DMA_IsEnabledChannel(DMA_Type *DMAx, uint32_t channel)
{
    ...
    {
        return (uint32_t)(READ_BIT(Temp->DMA_CH7CR, DMA_CHCR_EN_Msk) == DMA_CHCR_EN_Msk);
    }
}
...
__STATIC_INLINE void FL_DMA_DisableChannel(DMA_Type *DMAx, uint32_t channel)
{
    ...
    {
        CLEAR_BIT(Temp->DMA_CH7CR, DMA_CHCR_EN_Msk);
    }
}
...
__STATIC_INLINE void FL_DMA_WriteTransmissionSize(DMA_Type *DMAx, uint32_t size, uint32_t channel)
{
    ...
    {
        MODIFY_REG(Temp->DMA_CH7CR, (0x1fffU << 16U), (size << 16U));
    }
}
...
__STATIC_INLINE uint32_t FL_DMA_ReadTransmissionSize(DMA_Type *DMAx, uint32_t channel)
{
    ...
    {
        return (uint32_t)(READ_BIT(Temp->DMA_CH7CR, (0x1fffU << 16U)) >> 16U);
    }
}
...
/**
  ...
  *           @arg @ref FL_DMA_CHANNEL_TAU0_0
  *           @arg @ref FL_DMA_CHANNEL_TAU0_1
  *           @arg @ref FL_DMA_CHANNEL_TAU0_2
  *           @arg @ref FL_DMA_CHANNEL_TAU0_3
  ...
  *           @arg @ref FL_DMA_CHANNEL_GPTIM3_CH1
  *           @arg @ref FL_DMA_CHANNEL_GPTIM3_CH2
  *           @arg @ref FL_DMA_CHANNEL_GPTIM3_CH3
  *           @arg @ref FL_DMA_CHANNEL_GPTIM3_CH4
  *           @arg @ref FL_DMA_CHANNEL_GPTIM3_TRI
  *           @arg @ref FL_DMA_CHANNEL_GPTIM3_UEV
  *           @arg @ref FL_DMA_CHANNEL_BSTIM0_TRI
  *           @arg @ref FL_DMA_CHANNEL_LPTIM0_TRI
  *           @arg @ref FL_DMA_CHANNEL_ADC0_REQ0
  *           @arg @ref FL_DMA_CHANNEL_ADC0_REQ1
  *           @arg @ref FL_DMA_CHANNEL_ADC0_REQ2
  *           @arg @ref FL_DMA_CHANNEL_ADC0_REQ3
  *           @arg @ref FL_DMA_CHANNEL_ADC0_REQ4
  *           @arg @ref FL_DMA_CHANNEL_ADC1_REQ0
  *           @arg @ref FL_DMA_CHANNEL_ADC1_REQ1
  *           @arg @ref FL_DMA_CHANNEL_ADC1_REQ2
  *           @arg @ref FL_DMA_CHANNEL_ADC1_REQ3
  *           @arg @ref FL_DMA_CHANNEL_ADC1_REQ4
  *           @arg @ref FL_DMA_CHANNEL_TAU1_0
  *           @arg @ref FL_DMA_CHANNEL_TAU1_1
  *           @arg @ref FL_DMA_CHANNEL_TAU1_2
  *           @arg @ref FL_DMA_CHANNEL_TAU1_3
  *           @arg @ref FL_DMA_CHANNEL_DAC0
  *           @arg @ref FL_DMA_CHANNEL_TAU2_0
  *           @arg @ref FL_DMA_CHANNEL_TAU2_1
  *           @arg @ref FL_DMA_CHANNEL_TAU2_2
  *           @arg @ref FL_DMA_CHANNEL_TAU2_3
...
__STATIC_INLINE void FL_DMA_SetPriority(DMA_Type *DMAx, uint32_t priority, uint32_t channel)
{
    ...
    {
        MODIFY_REG(Temp->DMA_CH7CR, DMA_DMA_CH7CR_PRI_Msk, priority << 12);
    }
}
...
__STATIC_INLINE uint32_t FL_DMA_GetPriority(DMA_Type *DMAx, uint32_t channel)
{
    ...
    {
        return (uint32_t)(READ_BIT(Temp->DMA_CH7CR, DMA_DMA_CH7CR_PRI_Msk) >> DMA_DMA_CH7CR_PRI_Pos);
    }
}
...
__STATIC_INLINE void FL_DMA_EnableIT_TransferComplete(DMA_Type *DMAx, uint32_t channel)
{
    ...
    {
        SET_BIT(Temp->DMA_CH7CR, DMA_CFGR_FTIE_Msk);
    }
}
...
__STATIC_INLINE uint32_t FL_DMA_IsEnabledIT_TransferComplete(DMA_Type *DMAx, uint32_t channel)
{
    ...
    {
        return (uint32_t)(READ_BIT(Temp->DMA_CH7CR, DMA_CFGR_FTIE_Msk) == DMA_CFGR_FTIE_Msk);
    }
}
...
__STATIC_INLINE void FL_DMA_DisableIT_TransferComplete(DMA_Type *DMAx, uint32_t channel)
{
    ...
    {
        CLEAR_BIT(Temp->DMA_CH7CR, DMA_CFGR_FTIE_Msk);
    }
}
...
__STATIC_INLINE void FL_DMA_EnableIT_TransferHalfComplete(DMA_Type *DMAx, uint32_t channel)
{
    ...
    {
        SET_BIT(Temp->DMA_CH7CR, DMA_CFGR_HTIE_Msk);
    }
}
...
__STATIC_INLINE uint32_t FL_DMA_IsEnabledIT_TransferHalfComplete(DMA_Type *DMAx, uint32_t channel)
{
    ...
    {
        return (uint32_t)(READ_BIT(Temp->DMA_CH7CR, DMA_CFGR_HTIE_Msk) == DMA_CFGR_HTIE_Msk);
    }
}
...
__STATIC_INLINE void FL_DMA_DisableIT_TransferHalfComplete(DMA_Type *DMAx, uint32_t channel)
{
    ...
    {
        CLEAR_BIT(Temp->DMA_CH7CR, DMA_CFGR_HTIE_Msk);
    }
}
...
__STATIC_INLINE void FL_DMA_SetTransmissionDirection(DMA_Type *DMAx, uint32_t direction, uint32_t channel)
{
    ...
    {
        MODIFY_REG(Temp->DMA_CH7CR, DMA_DMA_CH7CR_DIR_Msk, direction);
    }
}
...
__STATIC_INLINE uint32_t FL_DMA_GetTransmissionDirection(DMA_Type *DMAx, uint32_t channel)
{
    ...
    {
        return (uint32_t)(READ_BIT(Temp->DMA_CH7CR, DMA_DMA_CH7CR_DIR_Msk));
    }
}
...
/**
  ...
  * @rmtoll   DMA_CH7CR    RINC    FL_DMA_SetFlashMemoryIncrementMode
...
{
    MODIFY_REG(DMAx->CH7CR, DMA_DMA_CH7CR_RINC_Msk, mode);
}

/**
  * @brief    Get  Flash channel RAM address incremental status
  * @rmtoll   DMA_CH7CR    RINC    FL_DMA_GetFlashRamIncrementMode
  * @param    DMAx DMA instance
  * @retval   Returned value can be one of the following values:
  *           @arg @ref FL_DMA_CH7_RAM_INC_MODE_INCREASE
  *           @arg @ref FL_DMA_CH7_RAM_INC_MODE_DECREASE
...
{
    return (uint32_t)(READ_BIT(DMAx->CH7CR, DMA_DMA_CH7CR_RINC_Msk) == DMA_DMA_CH7CR_RINC_Msk);
}

/**
  * @brief    Get  Flash channel RAM address incremental status
  * @rmtoll   DMA_CH7CR    FINC    FL_DMA_GetFlashAddrIncremental
  * @param    DMAx DMA instance
  * @retval   Returned value can be one of the following values:
  *           @arg @ref FL_DMA_CH7_RAM_INC_MODE_INCREASE
  *           @arg @ref FL_DMA_CH7_RAM_INC_MODE_DECREASE
...
{
    return (uint32_t)(READ_BIT(DMAx->CH7CR, DMA_DMA_CH7CR_FINC_Msk) == DMA_DMA_CH7CR_FINC_Msk);
}

/**
  * @brief    Set Flash channel RAM address incremental
  * @rmtoll   DMA_CH7CR    FINC    FL_DMA_SetFlashAddrIncremental
...
{
    MODIFY_REG(DMAx->CH7CR, DMA_DMA_CH7CR_FINC_Msk, mode);
}

/**
  * @brief    DMA address error interrupt enable
  * @rmtoll   DMA_GCR    ADDRERR_IE    FL_DMA_EnableIT_AddressError
  * @param    DMAx DMA instance
  * @retval   None
  */
...
/**
  ...
  * @rmtoll   DMA_GCR    ADDRERR_IE    FL_DMA_IsEnabledIT_AddressError
  * @param    DMAx DMA instance
  * @retval   State of bit (1 or 0).
  */
...
/**
  ...
  * @rmtoll   DMA_GCR    ADDRERR_IE    FL_DMA_DisableIT_AddressError
  * @param    DMAx DMA instance
  * @retval   None
  */
...
/**
  * @brief    DMA enable
  * @rmtoll   DMA_GCR    EN    FL_DMA_Enable
  * @param    DMAx DMA instance
  * @retval   None
  */
...
/**
  ...
  * @rmtoll   DMA_GCR    EN    FL_DMA_IsEnabled
  * @param    DMAx DMA instance
  * @retval   State of bit (1 or 0).
  */
...
/**
  * @brief    DMA disable
  * @rmtoll   DMA_GCR    EN    FL_DMA_Disable
  * @param    DMAx DMA instance
  * @retval   None
  */
