...
#ifndef __FM33LR0XX_FL_QSPI_H
#define __FM33LR0XX_FL_QSPI_H
...
#define    QSPI_DATA_DATA_Msk                                     (0xffffffffU << QSPI_DATA_DATA_Pos)
#define    QSPI_DATA_DATA                                         QSPI_DATA_DATA_Msk
...
/**
  * @brief    
  * @rmtoll   DATA    DATA    FL_QSPI_WriteData
  * @param    QSPIx QSPI instance
  * @param    data 
  * @retval   None
  */
...
{
    MODIFY_REG(QSPIx->DATA, (0xffffffffU << 0U), (data << 0U));
}

/**
  * @brief    
  * @rmtoll   DATA    DATA    FL_QSPI_ReadData
  * @param    QSPIx QSPI instance
  * @retval   
  */
__STATIC_INLINE uint32_t FL_QSPI_ReadData(QSPI_Type* QSPIx)
{
    return (uint32_t)(READ_BIT(QSPIx->DATA, (0xffffffffU << 0U)) >> 0U);
}
