...
#ifndef __FM33LD5XX_FL_IWDT_H
#define __FM33LD5XX_FL_IWDT_H
...
__STATIC_INLINE uint32_t FL_IWDT_GetPeriod(IWDT_Type* IWDTx)
{
	volatile uint32_t val = 0;
    uint32_t temp;
    temp = (uint32_t)(READ_BIT(IWDTx->CR, IWDT_CR_OVP_Msk));
    val = READ_REG(IWDTx->SERV);
    return temp;
}
...
#endif /* __FM33LD5XX_FL_IWDT_H*/

/*************************Py_Code_Generator Version: 0.1-0.14-0.1 @ 2025-02-19*************************/
