...
#ifndef __FM33LD5XX_FL_PGL_H
#define __FM33LD5XX_FL_PGL_H
...
/**
  ...
  * @param    PGLx PGL instance
  * @param    truth This parameter can be one of the following values:
  *           @arg @ref FL_PGL_LUT0
  *           @arg @ref FL_PGL_LUT1
  *           @arg @ref FL_PGL_LUT2
  *           @arg @ref FL_PGL_LUT3
